...
<title>Online Bank</title>
	...
	<nav>
		...
		<a  href="${pageContext.request.contextPath}/">Online Bank</a>
	...
	<div>
	<br>
	<h3>Savings Account Balance: <br> $ ${savingsAccount.accountBalance}</h3>
	...
	<thead>
		...
		<c:if test="${not empty savingsTransactionList}">
			<c:forEach items="${savingsTransactionList}" var="list">
		<tr>
			<td>${list.date}</td>
